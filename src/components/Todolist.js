...
function Todolist({ index, todo, completeTodo, deleteTodo }) {
  return (
      <StyledCard style={todo.isCompleted ? {color: 'red', textDecoration: 'line-through'} : {color: 'white', textDecoration: 'none'} }>
          ...
          <div>
            ...
            <FontAwesomeIcon icon={faTrash} style={{cursor: 'pointer', padding: '0 8px 0 0'}} onClick={ () => deleteTodo(index) }></FontAwesomeIcon>
          </div>
    </StyledCard>
  )
}
